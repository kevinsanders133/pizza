            ...
            <form onSubmit={onSubmit} className="popup">
                ...
                <div className="popup__content">
                    ...
                    <div className="popup__quantity-container">
                        ...
                        <input type="number" min={1} max={10} defaultValue={1} className="popup__quantity" />
                    ...
                    <div className="popup__extras-container">
                        <div className="popup__extras-item">
                            <input type="checkbox" defaultValue={1} onClick={changeExtras} className="popup__extra-checkbox" />
                            <Extra extraId={1} photo="bacon.png" />
                        </div>

                        <div className="popup__extras-item">
                            <input type="checkbox" defaultValue={2} onClick={changeExtras} className="popup__extra-checkbox" />
                            <Extra extraId={2} photo="tomatos.png" />
                        </div>

                        <div className="popup__extras-item">
                            <input type="checkbox" defaultValue={3} onClick={changeExtras} className="popup__extra-checkbox" />
